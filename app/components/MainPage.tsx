...
export default function MainPage() {
	...
	const [news, setNews] = useState([
		...
		},
		{
			...
			content: "Tervezett karbantartás miatt szeptember 20-án 8-12 óráig internet kimaradás várható.",
		},
		{
			id: "5",
			...
			<div className="grid grid-cols-2 gap-6 px-4 my-4">
				...
				<div className="flex flex-col gap-6">
					<div className="surface-card shadow-2xl rounded-md h-96 overflow-hidden">
						<DataScrollerSchema dataTableValue={news} title={"Hírek"} type="news" />
					</div>
					<div className="surface-card shadow-2xl rounded-md h-96 overflow-hidden">
						<DataScrollerSchema dataTableValue={tasks} title={"Feladatok"} type="tasks" />
