			...
			<div className="flex-1 overflow-hidden">
				<DataTable
					...
					pt={{
						...
						header: {
							className: " text-gray-700 font-semibold p-3 border-b  select-none",
						},
						tbody: { className: "align-middle" }, // tbody-ra alkalmazott stílus pl.
						bodyRow: {
							className: "hover:bg-gray-600/30 hover:text-gray-50  border-b",
						},
					}}
				>
					...
					<div className="h-full">
						<DataTable
							...
							pt={{
								...
								tbody: { className: "align-middle" }, // tbody-ra alkalmazott stílus pl.
								bodyRow: {
									className: "hover:bg-gray-50 even:bg-gray-50 border-b border-gray-200",
								},
							}}
						>
